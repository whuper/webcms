...
# 转存表中的数据：tp_admin 
INSERT INTO `tp_admin` VALUES ('1','admin','0731a9e4628ba4dafe3c9b4e576ad7e2','umqvjg','','','9','1408616745','127.0.0.1','0');
...
&lt;/style&gt; 
&lt;![endif]--&gt;</span>鉴于 IE/Mac的市场占有率极低,我们直接忽略掉,最后精简的代码如下:</pre><p>&nbsp;.clearfix:after {content:&quot;.&quot;; display:block; height:0; visibility:hidden; clear:both;&nbsp;}</p><p>.clearfix { *zoom:1; }</p><p><strong><span style="font-size: 14px;"><br/></span></strong><a href="http://www.iyunlu.com/demo/enclosing-float-and-clearing-float/index.html#float7" target="_blank"><strong><span style="font-size: 14px;"></span></strong></a></p><p>优点：结构和语义化完全正确,代码量居中</p><p>缺点：复用方式不当会造成代码量增加</p><p><strong><span style="font-size: 14px;">&nbsp;小结</span></strong></p><p>通过对比，我们不难发现，其实以上列举的方法，无非有两类：</p><p>其一，通过在浮动元素的末尾添加一个空元素，设置 clear：both属性，after伪元素其实也是通过 content 在元素的后面生成了内容为一个点的块级元素；</p><p>其二，通过设置父元素 overflow 或者display：table 属性来闭合浮动，我们来探讨一下这里面的原理。</p><p>在CSS2.1里面有一个很重要的概念，但是国内的技术博客介绍到的比较少，那就是<a href="http://www.w3.org/TR/CSS21/visuren.html#block-formatting" target="_blank"> Block formatting contexts </a>（块级格式化上下文），以下简称 BFC。</p><p>CSS3里面对这个规范做了改动，称之为：<a href="http://www.w3.org/TR/css3-box/#block-level0" target="_blank">flow root</a>，并且对触发条件进行了进一步说明。</p><p><strong>那么如何触发BFC呢？</strong></p><ul><li><span style="color: #800000;">float 除了none以外的值</span> <br/>
 &nbsp; &nbsp;&nbsp;</li><li><span style="color: #800000;">overflow 除了visible 以外的值（hidden，auto，scroll ）</span> <br/>
 &nbsp; &nbsp;&nbsp;</li><li><span style="color: #800000;">display (table-cell，table-caption，inline-block)</span> <br/>
 &nbsp; &nbsp;&nbsp;</li><li><span style="color: #800000;">position（absolute，fixed）</span> <br/>
 &nbsp; &nbsp;&nbsp;</li><li><span style="color: #800000;">fieldset元素</span></li></ul><p>需要注意的是，display:table 本身并不会创建BFC，但是它会产生<a href="http://www.w3.org/TR/CSS21/tables.html#anonymous-boxes">匿名框</a>(anonymous
 
boxes)，而匿名框中的display:table-cell可以创建新的BFC，换句话说，触发块级格式化上下文的是匿名框，而不是
display:table。所以通过display:table和display:table-cell创建的BFC效果是不一样的。</p><p>&nbsp;fieldset 元素在www.w3.org里目前没有任何有关这个触发行为的信息，直到<a href="http://jeehon.info/log/2011/11/11/block-formatting-contexts%E5%9D%97%E7%BA%A7%E6%A0%BC%E5%BC%8F%E5%8C%96%E4%B8%8A%E4%B8%8B%E6%96%87/www.w3.org/TR/html5/the-xhtml-syntax.html#the-fieldset-element-0">HTML5</a>标准里才出现。有些浏览器bugs（Webkit，Mozilla）提到过这个触发行为，但是没有任何官方声明。实际上，即使fieldset在大多数的浏览器上都能创建新的块级格式化上下文，开发者也不应该把这当做是理所当然的。<code>CSS 2.1没有定义哪种属性适用于表单控件，也没有定义如何使用CSS来给它们添加样式。用户代理可能会给这些属性应用CSS属性，建议开发者们把这种支持当做实验性质的，更高版本的CSS可能会进一步规范这个。</code></p><p>&nbsp;</p><p>BFC的特性：</p><h3><span style="color: #0000ff;">1)块级格式化上下文会阻止外边距叠加</span></h3><p>当两个相邻的块框在同一个块级格式化上下文中时，它们之间垂直方向的外边距会发生<a href="http://www.w3.org/TR/CSS21/box.html#collapsing-margins">叠加</a>。换句话说，如果这两个相邻的块框不属于同一个块级格式化上下文，那么它们的外边距就不会叠加。</p><h3><span style="color: #0000ff;">2)块级格式化上下文不会重叠浮动元素</span></h3><p>根据规定，一个块级格式化上下文的边框不能和它里面的元素的外边距重叠。这就意味着浏览器将会给块级格式化上下文创建隐式的外边距来阻止它和浮动元
素的外边距叠加。由于这个原因，当给一个挨着浮动的块级格式化上下文添加负的外边距时将会不起作用（Webkit和IE6在这点上有一个问题——可以看这
个<a href="http://www.tjkdesign.com/lab/bfc/test.html" target="_blank">测试用例</a>）。&nbsp;</p><h3><span style="color: #0000ff;">3)块级格式化上下文通常可以包含浮动</span></h3><p>详见： W3C CSS2.1 - 10.6.7 &#39;<a href="http://www.w3.org/TR/CSS2/visudet.html#root-height" target="_blank">Auto&#39; heights for block formatting context roots</a>&nbsp;<br/>&nbsp;&nbsp;</p><p>通俗地来说：创建了 BFC的元素就是一个独立的盒子，里面的子元素不会在布局上影响外面的元素，反之亦然，同时BFC任然属于文档中的普通流。</p><p>至此，您或许明白了为什么 overflow:hidden或者auto可以闭合浮动了，真是因为父元素创建了新的BFC。对于张鑫旭在对<a href="http://www.zhangxinxu.com/wordpress/?p=621" target="_blank">《overflow与zoom”清除浮动”的一些认识 》</a>一文中对于用包裹来解释闭合浮动的原理，我觉得是不够严谨的，而且没有依据。<span style="font-size: 12px;">并且说道“<span style="line-height: 22px; font-family: &#39;Lucida Grande&#39;,Verdana,Arial,sans-serif;">Firefox等浏览器并没有haslayout的概念</span>”，</span>那么现代浏览器是有BFC的，从表现上来说，hasLayout 可以等同于 BFC。</p><p>IE6-7的显示引擎使用的是一个称为布局（layout）的内部概念，由于这个显示引擎自身存在很多的缺陷，直接导致了IE6-7的很多显示
bug。当我们说一个元素“得到 layout”，或者说一个元素“拥有 layout” 的时候，我们的意思是指它的微软专有属性 hasLayout <a href="http://msdn.microsoft.com/workshop/author/dhtml/reference/properties/haslayout.asp" target="_blank">http://msdn.microsoft.com/worksh ... rties/haslayout.asp</a> 为此被设为了 true 。IE6-7使用布局的概念来控制元素的尺寸和定位，那些拥有布局（have layout）的元素负责本身及其子元素的尺寸设置和定位。如果一个元素的 hasLayout 为false，那么它的尺寸和位置由最近拥有布局的祖先元素控制。</p><p>触发hasLayout的条件：</p><ul><li><span style="color: #800000;">position: absolute</span> <br/>
 &nbsp; &nbsp;&nbsp;</li><li><span style="color: #800000;">float: left|right</span> <br/>
 &nbsp; &nbsp;&nbsp;</li><li><span style="color: #800000;">display: inline-block</span> <br/>
 &nbsp; &nbsp;&nbsp;</li><li><span style="color: #800000;">width: 除 “auto” 外的任意值</span> <br/>
 &nbsp; &nbsp;&nbsp;</li><li><span style="color: #800000;">height: 除 “auto” 外的任意值 （例如很多人清除浮动会用到 height: 1%&nbsp;&nbsp;）</span> <br/>
 &nbsp; &nbsp;&nbsp;</li><li><span style="color: #800000;">zoom: 除 “normal” 外的任意值 (MSDN) </span><a href="http://msdn.microsoft.com/workshop/author/dhtml/reference/properties/zoom.asp" target="_blank"><span style="color: #800000;">http://msdn.microsoft.com/worksh ... properties/zoom.asp</span></a> <br/>
 &nbsp; &nbsp;&nbsp;</li><li><span style="color: #800000;">writing-mode: tb-rl (MSDN) </span><a href="http://msdn.microsoft.com/workshop/author/dhtml/reference/properties/writingmode.asp" target="_blank"><span style="color: #800000;">http://msdn.microsoft.com/worksh ... ies/writingmode.asp</span></a></li></ul><p>在 IE7 中，overflow 也变成了一个 layout 触发器：</p><ul><li><span style="color: #800000;">overflow: hidden|scroll|auto&nbsp;</span>（ 这个属性在IE之前版本中没有触发 layout 的功能。&nbsp;）<br/>
 &nbsp; &nbsp;&nbsp;</li><li><span style="color: #800000;">overflow-x|-y: hidden|scroll|auto</span> （CSS3 盒模型中的属性，尚未得到浏览器的广泛支持。他们在之前IE版本中同样没有触发 layout 的功能）</li></ul><p>hasLayout更详细的解释请参见 old9翻译的 大名鼎鼎的 <strong>《On having layout》</strong>一文（英文原文：<a href="http://www.satzansatz.de/cssd/onhavinglayout.htm" target="_blank">http://www.satzansatz.de/cssd/onhavinglayout.htm</a>），由于old9博客被墙，中文版地址：</p><p>IE8使用了全新的显示引擎，据称不使用 hasLayout属性了，因此解决了很多深恶痛绝的bug。</p><h2><span style="color: #0000ff;"><span style="font-size: 14px;">综上所述：</span></span></h2><h2><span style="color: #0000ff;"><span style="font-size: 14px;">在支持BFC的浏览器（IE8+，firefox，chrome，safari）通过创建新的BFC闭合浮动；</span></span></h2><h2><span style="color: #0000ff;"><span style="font-size: 14px;">在不支持 BFC的浏览器 （IE6-7），通过触发 hasLayout 闭合浮动。</span></span></h2><p>&nbsp;</p><h2>四、闭合浮动方法——精益求精</h2><p>上面已经列举了7种闭合浮动的方法，通过第三节分析的原理，我们发现其实更多的：display：table-
cell，display：inline-block等只要触发了BFC的属性值都可以闭合浮动。从各个方面比较，after伪元素闭合浮动无疑是相对比
较好的解决方案了，下面详细说说该方法。</p><p>.clearfix:after {content:&quot;.&quot;; display:block; height:0; visibility:hidden; clear:both;&nbsp;}</p><p>.clearfix { *zoom:1; }</p><p>1) display:block 使生成的元素以块级元素显示,占满剩余空间;</p><p>2) height:0 避免生成内容破坏原有布局的高度。</p><p>3) visibility:hidden&nbsp;使生成的内容不可见，并允许可能被生成内容盖住的内容可以进行点击和交互;</p><p>4）通过 content:&quot;.&quot;生成内容作为最后一个元素，至于content里面是点还是其他都是可以的，例如oocss里面就有经典的 
content:&quot;XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX&quot;,有些版本可能content 
里面内容为空,一丝冰凉是不推荐这样做的,firefox直到7.0&nbsp;content:”&quot; 仍然会产生额外的空隙；</p><p>5）zoom：1 触发IE hasLayout。</p><p>通过分析发现，除了clear：both用来清除浮动的，其他代码无非都是为了隐藏掉content生成的内容，这也就是其他版本的闭合浮动为什么会有font-size：0，line-height：0。</p><p>&nbsp;</p><p><strong>精益求精方案一：</strong></p><p>相对于空标签闭合浮动的方法代码似乎还是有些冗余，通过查询发现Unicode字符里有一个“零宽度空格”，也就是<a href="http://www.fileformat.info/info/unicode/char/200b/index.htm" target="_blank">U+200B&nbsp;</a>，这个字符本身是不可见的，所以我们完全可以省略掉 visibility:hidden了</p><p>.clearfix:after {content:&quot;\200B&quot;; display:block; height:0; clear:both;&nbsp;}</p><p>.clearfix { *zoom:1; }.</p><p><strong>精益求精方案二：</strong></p><p>由Nicolas Gallagher 大湿提出来的,原文<a href="http://nicolasgallagher.com/micro-clearfix-hack/" target="_blank">:A new micro clearfix hack</a>，该方法也不存在firefox中空隙的问题。</p><p><span style="color: #993300;">/* For modern browsers */</span></p><p><span style="color: #993300;">.cf:before,.cf:after {</span></p><p><span style="color: #993300;">content:&quot;&quot;;</span></p><p><span style="color: #993300;">display:table;</span></p><p><span style="color: #993300;">}</span></p><p><span style="color: #993300;">.cf:after { clear:both; }/* For IE 6/7 (trigger hasLayout) */</span></p><p><span style="color: #993300;">.cf { zoom:1; }</span></p><p><span style="font-size: 14px;"><strong>&nbsp;需要注意的是：</strong></span></p><p>上面的方法用到了&nbsp; 
：before伪元素，很多人对这个有些迷惑，到底我什么时候需要用before呢？为什么方案一没有呢？其实它是用来处理margin边距重叠的，由于
内部元素 float 创建了BFC，导致内部元素的margin-top和 上一个盒子的margin-bottom 
发生叠加。如果这不是你所希望的，那么就可以加上before，如果只是单纯的闭合浮动，after就够了！并不是如同大漠<a href="http://www.w3cplus.com/css/clear-float" target="_blank">《Clear Float》</a>一文所说的：但只使用clearfix:after时在跨浏览器兼容问题会存在一个垂直边距叠加的bug，这不是bug，是BFC应该有的特性。</p><p><img src="http://www.iyunlu.com/d/file/view/css-xhtml/2012-05-09/7da7b2c795a2e4249ca89a4900f3ec2b.jpg" alt="边距叠加测试.jpg" height="258" width="379"/></p><p><a href="http://www.iyunlu.com/demo/block-formatting-contexts/" target="_blank"><span style="font-size: 14px;"><span style="color: #0000ff;"><strong><br/></strong></span></span></a></p><p><span style="color: #3366ff;"><span style="font-size: 14px;"><strong>进一步了解请看： <a href="http://www.iyunlu.com/view/css-xhtml/56.html" target="_blank">《clearfix改良及overflow:hidden详解【译】》</a></strong></span></span></p><p>在实际开发中，改进方案一由于存在Unicode字符不适合内嵌CSS的GB2312编码的页面，使用方案7完全可以解决我们的需求了，改进方案二
等待大家的进一步实践。方案3、4通过overflow闭合浮动，实际上已经创建了新的 
块级格式化上下文，这将导致其布局和相对于浮动的行为等发生一系列的变化，清除浮动只不过是一系列变化中的一个作用而已。所以为了闭合浮动去改变全局特
性，这是不明智的，带来的风险就是一系列的bug，比如firefox 早期版本产生 
focus，截断绝对定位的层等等。始终要明白，如果单单只是需要闭合浮动，overflow就不要使用，而不是某些文章所说的“慎用”。</p><p>前前后后花了三天写完了这篇文章。如果觉得本文对您有帮助，您的留言就是对我最大的支持，同时由于精力有限，欢迎指出文中错误与不足，共勉之！</p><p><span style="font-size: 14px;"><strong>参考资料:</strong></span></p><p>&nbsp;</p><ul><li>Page breaks and block-formatting contexts: <a href="http://www.w3.org/TR/CSS21/page.html#allowed-page-breaks">Allowed page breaks (13.3.3)</a></li><li>Clearfix and block formatting contexts: <a href="http://carsonified.com/blog/design/everything-you-know-about-clearfix-is-wrong/">Everything you Know about Clearfix is Wrong</a></li></ul><ul><li><a href="http://dev.l-c-n.com/IEW/simulations.php">Block formating contexts, “hasLayout” – IE Window vs CSS2.1 browsers: simulations.</a></li><li><a href="http://www.brunildo.org/test/FloatMarginOverflow.html">New block formatting contexts next to floats</a></li><li><p><a href="http://www.communitymx.com/content/article.cfm?cid=6BC9D" target="_blank">Control Block Formatting Context</a></p></li></ul><ul><li><a href="http://www.satzansatz.de/cssd/onhavinglayout.html">On having layout</a>， [译文]On having layout &nbsp;http://old9.blogsome.com/2006/04/11/onhavinglayout</li><li><a href="http://msdn.microsoft.com/en-us/library/bb250481%28VS.85%29.aspx">“HasLayout” Overview</a></li><li><a href="http://msdn.microsoft.com/en-us/library/ms533776%28VS.85%29.aspx">hasLayout Property</a></li><li><a href="http://haslayout.net/haslayout" target="_blank">IE hasLayout</a></li><li>https://developer.mozilla.org/en/CSS/block_formatting_context</li></ul><p>&nbsp;</p><p>&nbsp;</p><p>转自：http://www.iyunlu.com/view/css-xhtml/55.html</p><p><br/></p>','浮动(float)，一个我们即爱又恨的属性。爱，因为通过浮动，我们能很方便地布局； 恨，浮动之后遗留下来太多的问题需要解决，特别是IE6-7（以下无特殊说明均指 windows 平台的 IE浏览器）。也许很多人都有这样的疑问，浮动从何而来？','1408328094','1408328107','69','1','1','0','','0','0','1','0');
INSERT INTO `tp_article` VALUES ('11','PHP采集淘宝商品','','','','','','','<pre><span style="color: #0000ff;">CREATE</span> <span style="color: #0000ff;">TABLE</span><span style="color: #000000;"> `goods` (
...
`type` &nbsp;</span><span style="color: #0000ff;">varchar</span>(<span style="color: #800000; font-weight: bold;">30</span>) <span style="color: #0000ff;">CHARACTER</span> <span style="color: #0000ff;">SET</span> utf8 COLLATE utf8_general_ci <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #ff0000;">&#39;&#39;</span><span style="color: #000000;"> ,
`keyid` &nbsp;</span><span style="color: #0000ff;">varchar</span>(<span style="color: #800000; font-weight: bold;">60</span>) <span style="color: #0000ff;">CHARACTER</span> <span style="color: #0000ff;">SET</span> utf8 COLLATE utf8_general_ci <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #ff0000;">&#39;&#39;</span><span style="color: #000000;"> ,
`shop_id` &nbsp;</span><span style="color: #0000ff;">int</span>(<span style="color: #800000; font-weight: bold;">11</span>) <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #800000; font-weight: bold;">0</span><span style="color: #000000;"> ,
`cid` &nbsp;</span><span style="color: #0000ff;">smallint</span>(<span style="color: #800000; font-weight: bold;">6</span>) <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #800000; font-weight: bold;">0</span><span style="color: #000000;"> ,
`img_id` &nbsp;</span><span style="color: #0000ff;">int</span>(<span style="color: #800000; font-weight: bold;">11</span>) <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #800000; font-weight: bold;">0</span><span style="color: #000000;"> ,
`imgs` &nbsp;</span><span style="color: #0000ff;">varchar</span>(<span style="color: #800000; font-weight: bold;">255</span>) <span style="color: #0000ff;">CHARACTER</span> <span style="color: #0000ff;">SET</span> utf8 COLLATE utf8_general_ci <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #0000ff;">NULL</span><span style="color: #000000;"> ,
...
`url` &nbsp;</span><span style="color: #0000ff;">varchar</span>(<span style="color: #800000; font-weight: bold;">255</span>) <span style="color: #0000ff;">CHARACTER</span> <span style="color: #0000ff;">SET</span> utf8 COLLATE utf8_general_ci <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #ff0000;">&#39;&#39;</span><span style="color: #000000;"> ,
`taoke_url` &nbsp;</span><span style="color: #0000ff;">varchar</span>(<span style="color: #800000; font-weight: bold;">255</span>) <span style="color: #0000ff;">CHARACTER</span> <span style="color: #0000ff;">SET</span> utf8 COLLATE utf8_general_ci <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #ff0000;">&#39;&#39;</span><span style="color: #000000;"> ,
`price` &nbsp;</span><span style="color: #0000ff;">decimal</span>(<span style="color: #800000; font-weight: bold;">10</span>,<span style="color: #800000; font-weight: bold;">2</span>) <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #800000; font-weight: bold;">0.00</span><span style="color: #000000;"> ,
`sellerid` &nbsp;</span><span style="color: #0000ff;">int</span>(<span style="color: #800000; font-weight: bold;">11</span>) UNSIGNED <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #0000ff;">NULL</span><span style="color: #000000;"> ,
`is_off_sale` &nbsp;</span><span style="color: #0000ff;">tinyint</span>(<span style="color: #800000; font-weight: bold;">1</span>) UNSIGNED <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #800000; font-weight: bold;">0</span><span style="color: #000000;"> ,
`delist_time` &nbsp;</span><span style="color: #0000ff;">int</span>(<span style="color: #800000; font-weight: bold;">11</span>) <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #800000; font-weight: bold;">0</span><span style="color: #000000;"> ,
`create_time` &nbsp;</span><span style="color: #0000ff;">int</span>(<span style="color: #800000; font-weight: bold;">11</span>) <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #800000; font-weight: bold;">0</span><span style="color: #000000;"> ,
`ctime` &nbsp;</span><span style="color: #0000ff;">int</span>(<span style="color: #800000; font-weight: bold;">11</span>) <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #0000ff;">NULL</span><span style="color: #000000;"> ,
`cache_data` &nbsp;</span><span style="color: #0000ff;">text</span> <span style="color: #0000ff;">CHARACTER</span> <span style="color: #0000ff;">SET</span> utf8 COLLATE utf8_general_ci <span style="color: #0000ff;">NULL</span><span style="color: #000000;"> ,
`create_day` &nbsp;</span><span style="color: #0000ff;">int</span>(<span style="color: #800000; font-weight: bold;">11</span>) <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #800000; font-weight: bold;">0</span><span style="color: #000000;"> ,
`commission` &nbsp;</span><span style="color: #0000ff;">decimal</span>(<span style="color: #800000; font-weight: bold;">10</span>,<span style="color: #800000; font-weight: bold;">2</span>) <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #800000; font-weight: bold;">0.00</span><span style="color: #000000;"> ,
`comment_collect_time` &nbsp;</span><span style="color: #0000ff;">int</span>(<span style="color: #800000; font-weight: bold;">11</span>) <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #800000; font-weight: bold;">0</span><span style="color: #000000;"> ,
`color` &nbsp;</span><span style="color: #0000ff;">smallint</span>(<span style="color: #800000; font-weight: bold;">6</span>) <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #800000; font-weight: bold;">0</span><span style="color: #000000;"> ,
`content` &nbsp;</span><span style="color: #0000ff;">text</span> <span style="color: #0000ff;">CHARACTER</span> <span style="color: #0000ff;">SET</span> utf8 COLLATE utf8_general_ci <span style="color: #0000ff;">NULL</span><span style="color: #000000;"> ,
`taobao_desc_url` &nbsp;</span><span style="color: #0000ff;">varchar</span>(<span style="color: #800000; font-weight: bold;">255</span>) <span style="color: #0000ff;">CHARACTER</span> <span style="color: #0000ff;">SET</span> utf8 COLLATE utf8_general_ci <span style="color: #808080;">NOT</span> <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #ff0000;">&#39;</span><span style="color: #ff0000;">\</span><span style="color: #ff0000;">&#39;</span>\<span style="color: #ff0000;">&#39;&#39;</span> COMMENT <span style="color: #ff0000;">&#39;</span><span style="color: #ff0000;">淘宝商品详细介绍地址</span><span style="color: #ff0000;">&#39;</span><span style="color: #000000;"> ,</span><span style="color: #0000ff;">PRIMARY</span> <span style="color: #0000ff;">KEY</span><span style="color: #000000;"> (`id`),</span><span style="color: #0000ff;">UNIQUE</span> <span style="color: #0000ff;">INDEX</span><span style="color: #000000;"> `keyid` (`keyid`) USING BTREE ,</span><span style="color: #0000ff;">INDEX</span><span style="color: #000000;"> `shop_id` (`shop_id`) USING BTREE ,</span><span style="color: #0000ff;">INDEX</span><span style="color: #000000;"> `delist_time` (`delist_time`) USING BTREE ,</span><span style="color: #0000ff;">INDEX</span><span style="color: #000000;"> `cid` (`cid`) USING BTREE ,</span><span style="color: #0000ff;">INDEX</span><span style="color: #000000;"> `create_day` (`create_day`) USING BTREE 
)
ENGINE</span><span style="color: #808080;">=</span><span style="color: #000000;">InnoDB</span><span style="color: #0000ff;">DEFAULT</span> <span style="color: #0000ff;">CHARACTER</span> <span style="color: #0000ff;">SET</span><span style="color: #808080;">=</span>utf8 COLLATE<span style="color: #808080;">=</span><span style="color: #000000;">utf8_general_ci
AUTO_INCREMENT</span><span style="color: #808080;">=</span><span style="color: #800000; font-weight: bold;">40614</span><span style="color: #000000;">ROW_FORMAT</span><span style="color: #808080;">=</span><span style="color: #000000;">COMPACT
;</span></pre><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><p>PHP文件:</p><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><pre>&lt;?<span style="color: #000000;">php</span><span style="color: #800080;">$con</span>=<span style="color: #008080;">mysql_connect</span>(&#39;localhost&#39;,&#39;root&#39;,&#39;&#39;<span style="color: #000000;">); 
</span><span style="color: #008080;">mysql_select_db</span>(&quot;fanwe&quot;, <span style="color: #800080;">$con</span><span style="color: #000000;">);</span><span style="color: #800080;">$start_time</span>=<span style="color: #008080;">microtime</span>(1<span style="color: #000000;">);</span><span style="color: #800080;">$sql</span>=&quot;SELECT id,price,url FROM s_goods WHERE url!=&#39;&#39; AND keyid like &#39;taobao%&#39; AND is_off_sale=0 ORDER BY id LIMIT 10&quot;;<span style="color: #008000;">//</span><span style="color: #008000;">更新前10个</span><span style="color: #800080;">$rs</span>=<span style="color: #008080;">mysql_query</span>(<span style="color: #800080;">$sql</span><span style="color: #000000;">);</span><span style="color: #0000ff;">echo</span> &#39;COUNT:&#39;.<span style="color: #008080;">mysql_num_rows</span>(<span style="color: #800080;">$rs</span>).&quot;\n&quot;<span style="color: #000000;">;</span><span style="color: #800080;">$error</span>=<span style="color: #0000ff;">array</span><span style="color: #000000;">();</span><span style="color: #800080;">$i</span>=0<span style="color: #000000;">;</span><span style="color: #800080;">$h</span>=<span style="color: #008080;">fopen</span>(&#39;d:/mydomain/updateprice.log&#39;,&#39;a+&#39;<span style="color: #000000;">);</span><span style="color: #0000ff;">while</span> (<span style="color: #800080;">$r</span>=<span style="color: #008080;">mysql_fetch_array</span>(<span style="color: #800080;">$rs</span><span style="color: #000000;">)){ &nbsp; &nbsp;</span><span style="color: #800080;">$s</span>=<span style="color: #008080;">microtime</span>(1<span style="color: #000000;">); &nbsp; &nbsp;</span><span style="color: #0000ff;">echo</span> <span style="color: #800080;">$i</span>++.&#39;:&#39;.<span style="color: #800080;">$r</span>[&#39;id&#39;].&quot;\t&quot;<span style="color: #000000;">; &nbsp; &nbsp;</span><span style="color: #800080;">$price</span>=getPrice(<span style="color: #800080;">$r</span>[&#39;url&#39;<span style="color: #000000;">]); &nbsp; &nbsp;</span><span style="color: #800080;">$t</span>=<span style="color: #008080;">microtime</span>(1)-<span style="color: #800080;">$s</span><span style="color: #000000;">; &nbsp; &nbsp;</span><span style="color: #0000ff;">echo</span> (<span style="color: #008080;">ceil</span>(<span style="color: #800080;">$t</span>*1000)/1000).&quot;\t&quot;<span style="color: #000000;">; &nbsp; &nbsp;</span><span style="color: #0000ff;">if</span>(<span style="color: #800080;">$price</span>===<span style="color: #0000ff;">false</span>) <span style="color: #0000ff;">echo</span> &#39;FALSE&#39;<span style="color: #000000;">; &nbsp; &nbsp;</span><span style="color: #0000ff;">elseif</span>(<span style="color: #008080;">bccomp</span>(<span style="color: #800080;">$price</span>,<span style="color: #800080;">$r</span>[&#39;price&#39;])==0) <span style="color: #0000ff;">echo</span> &#39;EQUAL&#39;<span style="color: #000000;">; &nbsp; &nbsp;</span><span style="color: #0000ff;">else</span><span style="color: #000000;">{ &nbsp; &nbsp; &nbsp; &nbsp;</span><span style="color: #0000ff;">echo</span> &quot;UPDATE\t&quot;.<span style="color: #800080;">$r</span>[&#39;price&#39;].&quot;\t&quot;.<span style="color: #800080;">$price</span><span style="color: #000000;">; &nbsp; &nbsp; &nbsp; &nbsp;</span><span style="color: #008080;">mysql_query</span>(&quot;UPDATE s_goods SET price=&quot;.<span style="color: #800080;">$price</span>.&quot; WHERE id=&quot;.<span style="color: #800080;">$r</span>[&#39;id&#39;<span style="color: #000000;">]);
 &nbsp; &nbsp; &nbsp; &nbsp;fputcsv(</span><span style="color: #800080;">$h</span>,<span style="color: #0000ff;">array</span>(<span style="color: #008080;">date</span>(&#39;Y-m-d H:i:s&#39;),<span style="color: #800080;">$r</span>[&#39;id&#39;],<span style="color: #800080;">$r</span>[&#39;price&#39;],<span style="color: #800080;">$price</span><span style="color: #000000;">));
 &nbsp; &nbsp;} &nbsp; &nbsp;</span><span style="color: #0000ff;">echo</span> &quot;\n&quot;<span style="color: #000000;">;
}</span><span style="color: #008080;">fclose</span>(<span style="color: #800080;">$h</span><span style="color: #000000;">);</span><span style="color: #0000ff;">echo</span> &#39;COUNT:&#39;.<span style="color: #008080;">mysql_num_rows</span>(<span style="color: #800080;">$rs</span>).&quot;\tTIME:&quot;.<span style="color: #008080;">ceil</span>(<span style="color: #008080;">microtime</span>(1)-<span style="color: #800080;">$start_time</span><span style="color: #000000;">);</span><span style="color: #0000ff;">function</span> getPrice(<span style="color: #800080;">$url</span>,<span style="color: #800080;">$time</span>=1<span style="color: #000000;">){ &nbsp; &nbsp;</span><span style="color: #800080;">$des_url</span>=&#39;&#39;<span style="color: #000000;">; &nbsp; &nbsp;</span><span style="color: #800080;">$ch</span> =<span style="color: #000000;"> curl_init();
 ...
 &nbsp; &nbsp;curl_close(</span><span style="color: #800080;">$ch</span><span style="color: #000000;">); &nbsp; &nbsp;</span><span style="color: #0000ff;">if</span>(<span style="color: #008080;">preg_match</span>(&quot;/&#39;reservePrice&#39;\s*:\s*&#39;([\d\.]+?)&#39;,/&quot;,<span style="color: #800080;">$content</span>,<span style="color: #800080;">$price</span><span style="color: #000000;">)){ &nbsp; &nbsp; &nbsp; &nbsp;</span><span style="color: #800080;">$price</span> = (<span style="color: #0000ff;">float</span>)<span style="color: #800080;">$price</span>[1<span style="color: #000000;">];
 &nbsp; &nbsp;}</span><span style="color: #0000ff;">elseif</span>(<span style="color: #008080;">preg_match</span>(&#39;/price:([\d\.]+?),/&#39;,<span style="color: #800080;">$content</span>,<span style="color: #800080;">$price</span><span style="color: #000000;">)){ &nbsp; &nbsp; &nbsp; &nbsp;</span><span style="color: #800080;">$price</span> = (<span style="color: #0000ff;">float</span>)<span style="color: #800080;">$price</span>[1<span style="color: #000000;">];
 &nbsp; &nbsp;} &nbsp; &nbsp;</span><span style="color: #0000ff;">if</span>(!<span style="color: #800080;">$price</span>&amp;&amp;<span style="color: #008080;">preg_match</span>(&#39;/tmall/&#39;,<span style="color: #800080;">$url</span>)){<span style="color: #008000;">//</span><span style="color: #008000;">天猫促销价 add LiuYang 2014-02-24 15:10</span>
        <span style="color: #008080;">preg_match</span>(&#39;/id=(\d+)+/&#39;,<span style="color: #800080;">$url</span>,<span style="color: #800080;">$temp</span><span style="color: #000000;">); &nbsp; &nbsp; &nbsp; &nbsp;</span><span style="color: #800080;">$url2</span>=&quot;http://mdskip.taobao.com/core/initItemDetail.htm?itemId=&quot;.<span style="color: #800080;">$temp</span>[1<span style="color: #000000;">]; &nbsp; &nbsp; &nbsp; &nbsp;</span><span style="color: #800080;">$ch</span> =<span style="color: #000000;"> curl_init();
 ...
 &nbsp; &nbsp; &nbsp; &nbsp;curl_close ( </span><span style="color: #800080;">$ch</span><span style="color: #000000;"> ); &nbsp; &nbsp; &nbsp; &nbsp;</span><span style="color: #800080;">$price_content</span>=json_decode(<span style="color: #008080;">iconv</span>(&#39;gbk&#39;,&#39;utf-8&#39;,<span style="color: #008080;">preg_replace</span>(&#39;/(\d{10,}):/&#39;,&#39;&quot;${1}&quot;:&#39;,<span style="color: #800080;">$price_content</span>)),<span style="color: #0000ff;">true</span><span style="color: #000000;">); &nbsp; &nbsp; &nbsp; &nbsp;</span><span style="color: #800080;">$priceinfo</span>=<span style="color: #800080;">$price_content</span>[&#39;defaultModel&#39;][&#39;itemPriceResultDO&#39;][&#39;priceInfo&#39;<span style="color: #000000;">]; &nbsp; &nbsp; &nbsp; &nbsp;</span><span style="color: #800080;">$price</span>=<span style="color: #0000ff;">array</span><span style="color: #000000;">(); &nbsp; &nbsp; &nbsp; &nbsp;</span><span style="color: #0000ff;">foreach</span> (<span style="color: #800080;">$priceinfo</span> <span style="color: #0000ff;">as</span> <span style="color: #800080;">$v</span><span style="color: #000000;">){ &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span><span style="color: #800080;">$price</span>[]=<span style="color: #800080;">$v</span>[&#39;price&#39;<span style="color: #000000;">]; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span><span style="color: #0000ff;">if</span>(<span style="color: #008080;">is_array</span>(<span style="color: #800080;">$v</span>[&#39;promotionList&#39;<span style="color: #000000;">])){ &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span><span style="color: #0000ff;">foreach</span> (<span style="color: #800080;">$v</span>[&#39;promotionList&#39;] <span style="color: #0000ff;">as</span> <span style="color: #800080;">$v2</span><span style="color: #000000;">){ &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span><span style="color: #800080;">$price</span>[]=<span style="color: #800080;">$v2</span>[&#39;extraPromPrice&#39;]?<span style="color: #800080;">$v2</span>[&#39;extraPromPrice&#39;]:<span style="color: #800080;">$v2</span>[&#39;price&#39;<span style="color: #000000;">];
 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;}
 ...
 &nbsp; &nbsp;} &nbsp; &nbsp;</span><span style="color: #0000ff;">if</span>(<span style="color: #800080;">$price</span>) <span style="color: #0000ff;">return</span> <span style="color: #800080;">$price</span><span style="color: #000000;">; &nbsp; &nbsp;</span><span style="color: #0000ff;">elseif</span>(<span style="color: #800080;">$time</span>==1) <span style="color: #0000ff;">return</span> getPrice(<span style="color: #800080;">$url</span>,2<span style="color: #000000;">); &nbsp; &nbsp;</span><span style="color: #0000ff;">else</span> <span style="color: #0000ff;">return</span> <span style="color: #0000ff;">false</span><span style="color: #000000;">;
}</span>?&gt;</pre><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><p>&nbsp;</p><p>执行方式如果采用apache或nginx等服务器,会因为各个服务器的最大响应时间而受影响.如果只更新10个那可能会完成,如果是上百个肯定是不能完全更新的.</p><p>可以采用PHP命令的等式来执行.</p><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><pre>D:\mydomain&gt;<span style="color: #000000;">php updateprice.php
COUNT:</span><span style="color: #800080;">10</span><span style="color: #800080;">0</span>:<span style="color: #800080;">36599</span> <span style="color: #800080;">0.232</span><span style="color: #000000;"> &nbsp; EQUAL</span><span style="color: #800080;">1</span>:<span style="color: #800080;">36600</span> <span style="color: #800080;">1.091</span><span style="color: #000000;"> &nbsp; EQUAL</span><span style="color: #800080;">2</span>:<span style="color: #800080;">36601</span> <span style="color: #800080;">1.039</span><span style="color: #000000;"> &nbsp; EQUAL</span><span style="color: #800080;">3</span>:<span style="color: #800080;">36603</span> <span style="color: #800080;">1.08</span><span style="color: #000000;"> &nbsp; &nbsp;EQUAL</span><span style="color: #800080;">4</span>:<span style="color: #800080;">36604</span> <span style="color: #800080;">0.984</span><span style="color: #000000;"> &nbsp; EQUAL</span><span style="color: #800080;">5</span>:<span style="color: #800080;">36605</span> <span style="color: #800080;">0.972</span><span style="color: #000000;"> &nbsp; EQUAL</span><span style="color: #800080;">6</span>:<span style="color: #800080;">36610</span> <span style="color: #800080;">1.019</span><span style="color: #000000;"> &nbsp; EQUAL</span><span style="color: #800080;">7</span>:<span style="color: #800080;">36611</span> <span style="color: #800080;">0.971</span><span style="color: #000000;"> &nbsp; EQUAL</span><span style="color: #800080;">8</span>:<span style="color: #800080;">36612</span> <span style="color: #800080;">1.048</span><span style="color: #000000;"> &nbsp; EQUAL</span><span style="color: #800080;">9</span>:<span style="color: #800080;">36613</span> <span style="color: #800080;">1.149</span><span style="color: #000000;"> &nbsp; EQUAL
COUNT:</span><span style="color: #800080;">10</span>        <span style="color: #0000ff;">TIME</span>:<span style="color: #800080;">10</span></pre><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><p>如此既清晰又明了,而且会一直执行到程序完成,不会担心服务器没有响应.</p><p>上面是在windows下面执行,如果输入php提示:</p><p><span style="background-color: #99ccff;">&#39;php&#39; 不是内部或外部命令，也不是可运行的程序</span><br/><span style="background-color: #99ccff;">或批处理文件。</span></p><p>就必须把php.exe所在的地址补全</p><p>D:\mydomain&gt;D:\AppServ\php5\php updatePrice.php</p><p>或者把php.exe所在的地址加入全局变量</p><p>此方法在Linux下同样有用只用修改对应的地址即可,在linux中php命令是可以直接用的.</p><p>[root@liu ~]# php updatePrice.php</p><p>&nbsp;</p><p>此方法有一个缺点,就是执行效率问题.一个商品采集平均需要0.8秒.那10000个商品采集完需要2个半小时.</p><p>如想继续了解,请看下篇.</p><p><br/></p>','CREATE TABLE `goods` (
`id` &nbsp;int(11) NOT NULL AUTO_INCREMENT ,
`type` &nbsp;varchar(30) CHARACTER SET utf8 COLLAT','1408328234','1408328234','36','1','1','0','','0','0','1','0');
INSERT INTO `tp_article` VALUES ('12','Linux下利用Shell使PHP并发采集淘宝产品','','','','','','','<p>上次项目中用到&lt;&lt;PHP采集淘宝商品&gt;&gt;</p><p>此方法有一个缺点,就是执行效率问题.一个商品采集平均需要0.8秒.那10000个商品采集完需要2个半小时.</p><p>首先想到的解决办法是并发.</p><p>但是PHP不支持并发(这里是指通过PHP命令执行PHP文件,如果通过apache或nginx等做服务器是可以并发的,是并发访问,不能在程序中实现并发).</p><p>通过Shell把对php命令推到后台执行,以达到并发的效果.</p><p>整体思路:</p><p>　　1.在Shell中连接数据库,取出需要更新的产品</p><p>　　2.Shell中对数据进行循环,把商品id,price,url传递给PHP执行,将执行过程推到后台</p><p>　　3.每循环20条使程序暂停5秒,达到控制并发数的目的</p><p>　　4.php得到id,price,url参数后,通过URL进行采集,并返回现价</p><p>　　5.将现价和原数据库中的价格进行比较,如果有变化或下架则更新.</p><p>　　6.将执行结果写入日志文件.</p><p>Shell</p><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><pre>#!/bin/<span style="color: #0000ff;">sh</span><span style="color: #000000;">#updateprice.</span><span style="color: #0000ff;">sh</span><span style="color: #000000;">j</span>=<span style="color: #800080;">0</span><span style="color: #000000;">currcyline</span>=<span style="color: #800080;">0</span><span style="color: #000000;">;
...
}</span></pre><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><p>执行结果:</p><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><pre><span style="color: #0000ff;">tail</span> -<span style="color: #800080;">10</span><span style="color: #000000;"> goodsUpdate.log</span><span style="color: #800000;">&quot;</span><span style="color: #800000;">2014-03-21 13:45:34</span><span style="color: #800000;">&quot;</span>,<span style="color: #800080;">13357</span>,<span style="color: #800080;">0.273</span><span style="color: #000000;">,EQUAL</span><span style="color: #800000;">&quot;</span><span style="color: #800000;">2014-03-21 13:45:35</span><span style="color: #800000;">&quot;</span>,<span style="color: #800080;">13380</span>,<span style="color: #800080;">5.883</span><span style="color: #000000;">,EQUAL</span><span style="color: #800000;">&quot;</span><span style="color: #800000;">2014-03-21 13:45:35</span><span style="color: #800000;">&quot;</span>,<span style="color: #800080;">13343</span>,<span style="color: #800080;">0.914</span><span style="color: #000000;">,EQUAL</span><span style="color: #800000;">&quot;</span><span style="color: #800000;">2014-03-21 13:45:35</span><span style="color: #800000;">&quot;</span>,<span style="color: #800080;">13344</span>,<span style="color: #800080;">0.923</span><span style="color: #000000;">,EQUAL</span><span style="color: #800000;">&quot;</span><span style="color: #800000;">2014-03-21 13:45:35</span><span style="color: #800000;">&quot;</span>,<span style="color: #800080;">13347</span>,<span style="color: #800080;">0.927</span>,UPDATE,<span style="color: #800080;">599.00</span>,<span style="color: #800080;">181.00</span><span style="color: #800000;">&quot;</span><span style="color: #800000;">2014-03-21 13:45:35</span><span style="color: #800000;">&quot;</span>,<span style="color: #800080;">13339</span>,<span style="color: #800080;">0.908</span><span style="color: #000000;">,EQUAL</span><span style="color: #800000;">&quot;</span><span style="color: #800000;">2014-03-21 13:45:35</span><span style="color: #800000;">&quot;</span>,<span style="color: #800080;">13342</span>,<span style="color: #800080;">0.93</span><span style="color: #000000;">,EQUAL</span><span style="color: #800000;">&quot;</span><span style="color: #800000;">2014-03-21 13:45:35</span><span style="color: #800000;">&quot;</span>,<span style="color: #800080;">13348</span>,<span style="color: #800080;">0.933</span><span style="color: #000000;">,EQUAL</span><span style="color: #800000;">&quot;</span><span style="color: #800000;">2014-03-21 13:45:35</span><span style="color: #800000;">&quot;</span>,<span style="color: #800080;">13349</span>,<span style="color: #800080;">0.946</span>,UPDATE,<span style="color: #800080;">1547.00</span>,<span style="color: #800080;">1877.00</span><span style="color: #800000;">&quot;</span><span style="color: #800000;">2014-03-21 13:45:35</span><span style="color: #800000;">&quot;</span>,<span style="color: #800080;">13338</span>,<span style="color: #800080;">0.947</span>,EQUAL</pre><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><p>此方法比只用PHP更新大大节约了时间,更新2万个商品大约是半小时.但是线程数非常不好控制</p><p><br/></p>','上次项目中用到&lt;&lt;PHP采集淘宝商品&gt;&gt;此方法有一个缺点,就是执行效率问题.一个商品采集平均需要0.8秒.那10000个商品采集完需要2个半小时.首先想到的解决办法是并发.但是PHP不支持并发(这里是指通过PHP命令','1408328302','1408328302','55','1','1','0','','0','0','1','0');
INSERT INTO `tp_article` VALUES ('13','Linux C连接Mysql','','','','','','','<p>首先确定系统上安装了GCC和MYSQL了没有,</p><p>如果没有先安装.CentOS用</p><p>yum -y install gcc</p><p>yum -y install mysql-server</p><p>此外还必须安装mysql-devel</p><p>安装成功检测:</p><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><pre>[root@liu mysql]# rpm -qa | grep <span style="color: #800000;">&#39;</span><span style="color: #800000;">gcc</span><span style="color: #800000;">&#39;</span><span style="color: #000000;"> &nbsp;libgcc</span>-<span style="color: #800080;">4.4</span>.<span style="color: #800080;">7</span>-<span style="color: #800080;">4</span><span style="color: #000000;">.el6.x86_64
gcc</span>-<span style="color: #800080;">4.4</span>.<span style="color: #800080;">7</span>-<span style="color: #800080;">4</span><span style="color: #000000;">.el6.x86_64
[root@liu mysql]# rpm </span>-qa | grep <span style="color: #800000;">&#39;</span><span style="color: #800000;">mysql</span><span style="color: #800000;">&#39;</span><span style="color: #000000;">mysql</span>-<span style="color: #800080;">5.1</span>.<span style="color: #800080;">73</span>-<span style="color: #800080;">3</span><span style="color: #000000;">.el6_5.x86_64
mysql</span>-devel-<span style="color: #800080;">5.1</span>.<span style="color: #800080;">73</span>-<span style="color: #800080;">3</span><span style="color: #000000;">.el6_5.x86_64
mysql</span>-libs-<span style="color: #800080;">5.1</span>.<span style="color: #800080;">73</span>-<span style="color: #800080;">3</span><span style="color: #000000;">.el6_5.x86_64
mysql</span>-server-<span style="color: #800080;">5.1</span>.<span style="color: #800080;">73</span>-<span style="color: #800080;">3</span>.el6_5.x86_64</pre><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><p>然后启动mysql</p><p>service mysqld start</p><p>进入Mysql创建数据库和表</p><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><pre>mysql<span style="color: #808080;">&gt;</span> <span style="color: #0000ff;">create</span> <span style="color: #0000ff;">database</span><span style="color: #000000;"> c_test;
mysql</span><span style="color: #808080;">&gt;</span> <span style="color: #0000ff;">use</span><span style="color: #000000;"> c_test</span><span style="color: #0000ff;">CREATE</span> <span style="color: #0000ff;">TABLE</span> `<span style="color: #ff00ff;">user</span><span style="color: #000000;">` (
`id` &nbsp;</span><span style="color: #0000ff;">int</span>(<span style="color: #800000; font-weight: bold;">11</span>) <span style="color: #808080;">NOT</span> <span style="color: #0000ff;">NULL</span><span style="color: #000000;"> AUTO_INCREMENT ,
`name` &nbsp;</span><span style="color: #0000ff;">varchar</span>(<span style="color: #800000; font-weight: bold;">30</span>) <span style="color: #0000ff;">CHARACTER</span> <span style="color: #0000ff;">SET</span> utf8 COLLATE utf8_general_ci <span style="color: #0000ff;">NULL</span> <span style="color: #0000ff;">DEFAULT</span> <span style="color: #ff0000;">&#39;&#39;</span><span style="color: #000000;"> ,</span><span style="color: #0000ff;">PRIMARY</span> <span style="color: #0000ff;">KEY</span><span style="color: #000000;"> (`id`)
)
ENGINE</span><span style="color: #808080;">=</span><span style="color: #000000;">InnoDB</span><span style="color: #0000ff;">DEFAULT</span> <span style="color: #0000ff;">CHARACTER</span> <span style="color: #0000ff;">SET</span><span style="color: #808080;">=</span>utf8 COLLATE<span style="color: #808080;">=</span><span style="color: #000000;">utf8_general_ci
;
mysql</span><span style="color: #808080;">&gt;</span> <span style="color: #0000ff;">insert</span> <span style="color: #0000ff;">into</span> <span style="color: #ff00ff;">user</span>(name) <span style="color: #0000ff;">values</span>(<span style="color: #ff0000;">&#39;</span><span style="color: #ff0000;">张三</span><span style="color: #ff0000;">&#39;</span>),(<span style="color: #ff0000;">&#39;</span><span style="color: #ff0000;">李四</span><span style="color: #ff0000;">&#39;</span>),(<span style="color: #ff0000;">&#39;</span><span style="color: #ff0000;">王五</span><span style="color: #ff0000;">&#39;</span><span style="color: #000000;">);
mysql</span><span style="color: #808080;">&gt;</span> <span style="color: #0000ff;">select</span> <span style="color: #808080;">*</span> <span style="color: #0000ff;">from</span> <span style="color: #ff00ff;">user</span><span style="color: #000000;">;</span><span style="color: #808080;">+</span><span style="color: #008080;">--</span><span style="color: #008080;">--+--------+</span><span style="color: #808080;">|</span> id <span style="color: #808080;">|</span> name   <span style="color: #808080;">|</span><span style="color: #808080;">+</span><span style="color: #008080;">--</span><span style="color: #008080;">--+--------+</span><span style="color: #808080;">|</span>  <span style="color: #800000; font-weight: bold;">1</span> <span style="color: #808080;">|</span> 张三 <span style="color: #808080;">|</span><span style="color: #808080;">|</span>  <span style="color: #800000; font-weight: bold;">2</span> <span style="color: #808080;">|</span> 李四 <span style="color: #808080;">|</span><span style="color: #808080;">|</span>  <span style="color: #800000; font-weight: bold;">3</span> <span style="color: #808080;">|</span> 王五 <span style="color: #808080;">|</span><span style="color: #808080;">+</span><span style="color: #008080;">--</span><span style="color: #008080;">--+--------+</span><span style="color: #800000; font-weight: bold;">3</span> rows <span style="color: #808080;">in</span> <span style="color: #0000ff;">set</span> (<span style="color: #800000; font-weight: bold;">0.00</span> sec)</pre><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><p>&nbsp;</p><p>创建mysql.c</p><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><pre><span style="color: #008000;">/*</span><span style="color: #008000;">
 ============================================================================
 Name &nbsp; &nbsp; &nbsp; &nbsp;: connect.c
 Author &nbsp; &nbsp; &nbsp;: 风飘无痕
 Version &nbsp; &nbsp; :
 ...
 ============================================================================ </span><span style="color: #008000;">*/</span><span style="color: #000000;">#include </span>&lt;stdio.h&gt;<span style="color: #000000;">#include </span>&lt;stdlib.h&gt;<span style="color: #000000;">#include </span>&lt;<span style="color: #0000ff;">string</span>.h&gt;<span style="color: #000000;">#include </span>&lt;mysql/mysql.h&gt;<span style="color: #000000;">MYSQL </span>*g_conn; <span style="color: #008000;">//</span><span style="color: #008000;"> mysql 连接</span>MYSQL_RES *g_res; <span style="color: #008000;">//</span><span style="color: #008000;"> mysql 记录集</span>MYSQL_ROW g_row; <span style="color: #008000;">//</span><span style="color: #008000;"> 字符串数组，mysql 记录行</span><span style="color: #0000ff;">#define</span> MAX_BUF_SIZE 1024 <span style="color: #008000;">//</span><span style="color: #008000;"> 缓冲区最大字节数</span><span style="color: #0000ff;">const</span> <span style="color: #0000ff;">char</span> *g_host_name = <span style="color: #800000;">&quot;</span><span style="color: #800000;">localhost</span><span style="color: #800000;">&quot;</span><span style="color: #000000;">;</span><span style="color: #0000ff;">const</span> <span style="color: #0000ff;">char</span> *g_user_name = <span style="color: #800000;">&quot;</span><span style="color: #800000;">root</span><span style="color: #800000;">&quot;</span><span style="color: #000000;">;</span><span style="color: #0000ff;">const</span> <span style="color: #0000ff;">char</span> *g_password = <span style="color: #800000;">&quot;</span><span style="color: #800000;">123456</span><span style="color: #800000;">&quot;</span><span style="color: #000000;">;</span><span style="color: #0000ff;">const</span> <span style="color: #0000ff;">char</span> *g_db_name = <span style="color: #800000;">&quot;</span><span style="color: #800000;">c_test</span><span style="color: #800000;">&quot;</span><span style="color: #000000;">;</span><span style="color: #0000ff;">const</span> unsigned <span style="color: #0000ff;">int</span> g_db_port = <span style="color: #800080;">3306</span><span style="color: #000000;">;</span><span style="color: #0000ff;">void</span> print_mysql_error(<span style="color: #0000ff;">const</span> <span style="color: #0000ff;">char</span> *msg) { <span style="color: #008000;">//</span><span style="color: #008000;"> 打印最后一次错误</span>
    <span style="color: #0000ff;">if</span><span style="color: #000000;"> (msg)
 &nbsp; &nbsp; &nbsp; &nbsp;printf(</span><span style="color: #800000;">&quot;</span><span style="color: #800000;">%s: %s\n</span><span style="color: #800000;">&quot;</span><span style="color: #000000;">, msg, mysql_error(g_conn)); &nbsp; &nbsp;</span><span style="color: #0000ff;">else</span><span style="color: #000000;">
 &nbsp; &nbsp; &nbsp; &nbsp;puts(mysql_error(g_conn));
}</span><span style="color: #0000ff;">int</span> executesql(<span style="color: #0000ff;">const</span> <span style="color: #0000ff;">char</span> *<span style="color: #000000;"> sql) { &nbsp; &nbsp;</span><span style="color: #008000;">/*</span><span style="color: #008000;">query the database according the sql</span><span style="color: #008000;">*/</span>
    <span style="color: #0000ff;">if</span> (mysql_real_query(g_conn, sql, strlen(sql))) <span style="color: #008000;">//</span><span style="color: #008000;"> 如果失败</span>
        <span style="color: #0000ff;">return</span> -<span style="color: #800080;">1</span>; <span style="color: #008000;">//</span><span style="color: #008000;"> 表示失败</span>

    <span style="color: #0000ff;">return</span> <span style="color: #800080;">0</span>; <span style="color: #008000;">//</span><span style="color: #008000;"> 成功执行</span><span style="color: #000000;">}</span><span style="color: #0000ff;">int</span> init_mysql() { <span style="color: #008000;">//</span><span style="color: #008000;"> 初始化连接 &nbsp; &nbsp;</span><span style="color: #008000;">//</span><span style="color: #008000;"> init the database connection</span>
    g_conn =<span style="color: #000000;"> mysql_init(NULL); &nbsp; &nbsp;
 &nbsp; &nbsp;</span><span style="color: #008000;">/*</span><span style="color: #008000;"> connect the database </span><span style="color: #008000;">*/</span>
    <span style="color: #0000ff;">if</span>(!mysql_real_connect(g_conn, g_host_name, g_user_name, g_password, g_db_name, g_db_port, NULL, <span style="color: #800080;">0</span>)) <span style="color: #008000;">//</span><span style="color: #008000;"> 如果失败</span>
        <span style="color: #0000ff;">return</span> -<span style="color: #800080;">1</span><span style="color: #000000;">; &nbsp; &nbsp;</span><span style="color: #008000;">//</span><span style="color: #008000;"> 是否连接已经可用 &nbsp; &nbsp;</span><span style="color: #008000;">//</span><span style="color: #008000;">if (executesql(&quot;set names utf8&quot;)) </span><span style="color: #008000;">//</span><span style="color: #008000;"> 如果失败 &nbsp; &nbsp; &nbsp; </span><span style="color: #008000;">//</span><span style="color: #008000;"> return -1;</span>
    <span style="color: #0000ff;">return</span> <span style="color: #800080;">0</span>; <span style="color: #008000;">//</span><span style="color: #008000;"> 返回成功</span><span style="color: #000000;">}</span><span style="color: #0000ff;">int</span> main(<span style="color: #0000ff;">void</span><span style="color: #000000;">) { &nbsp; &nbsp;</span><span style="color: #0000ff;">if</span><span style="color: #000000;"> (init_mysql());
 &nbsp; &nbsp; &nbsp; &nbsp;print_mysql_error(NULL); &nbsp; &nbsp;</span><span style="color: #0000ff;">char</span><span style="color: #000000;"> sql[MAX_BUF_SIZE]; &nbsp; &nbsp;</span><span style="color: #0000ff;">if</span><span style="color: #000000;"> (executesql(sql))
 &nbsp; &nbsp; &nbsp; &nbsp;print_mysql_error(NULL); &nbsp; &nbsp;</span><span style="color: #0000ff;">if</span> (executesql(<span style="color: #800000;">&quot;</span><span style="color: #800000;">select * from user</span><span style="color: #800000;">&quot;</span>)) <span style="color: #008000;">//</span><span style="color: #008000;"> 句末没有分号</span><span style="color: #000000;"> &nbsp; &nbsp; &nbsp; &nbsp;print_mysql_error(NULL);

 &nbsp; &nbsp;g_res </span>= mysql_store_result(g_conn); <span style="color: #008000;">//</span><span style="color: #008000;"> 从服务器传送结果集至本地，mysql_use_result直接使用服务器上的记录集</span>

    <span style="color: #0000ff;">int</span> iNum_rows = mysql_num_rows(g_res); <span style="color: #008000;">//</span><span style="color: #008000;"> 得到记录的行数</span>
    <span style="color: #0000ff;">int</span> iNum_fields = mysql_num_fields(g_res); <span style="color: #008000;">//</span><span style="color: #008000;"> 得到记录的列数</span><span style="color: #000000;">
 &nbsp; &nbsp;printf(</span><span style="color: #800000;">&quot;</span><span style="color: #800000;">共%d个记录，每个记录%d字段\n</span><span style="color: #800000;">&quot;</span><span style="color: #000000;">, iNum_rows, iNum_fields);

 &nbsp; &nbsp;puts(</span><span style="color: #800000;">&quot;</span><span style="color: #800000;">id\tname\n</span><span style="color: #800000;">&quot;</span><span style="color: #000000;">); &nbsp; &nbsp;</span><span style="color: #0000ff;">while</span> ((g_row=mysql_fetch_row(g_res))) <span style="color: #008000;">//</span><span style="color: #008000;"> 打印结果集</span>
        printf(<span style="color: #800000;">&quot;</span><span style="color: #800000;">%s\t%s\n</span><span style="color: #800000;">&quot;</span>, g_row[<span style="color: #800080;">0</span>], g_row[<span style="color: #800080;">1</span>]); <span style="color: #008000;">//</span><span style="color: #008000;"> 第一，第二字段</span><span style="color: #000000;">
 &nbsp; &nbsp;mysql_free_result(g_res); </span><span style="color: #008000;">//</span><span style="color: #008000;"> 释放结果集</span><span style="color: #000000;">
 &nbsp; &nbsp;mysql_close(g_conn); </span><span style="color: #008000;">//</span><span style="color: #008000;"> 关闭链接</span>

    <span style="color: #0000ff;">return</span><span style="color: #000000;"> EXIT_SUCCESS;
}</span></pre><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><p>&nbsp;</p><p>编译</p><pre>gcc -g -o mysql -I/usr/include/mysql/ connect.c -L/usr/lib64/mysql/ -lmysqlclient -lz</pre><p>编译的时候要注意用到2个路径,mysql.h和libmysqlclient.so的路径</p><p>查找mysql.h路径</p><pre>[root@liu mysql]# find / -name <span style="color: #800000;">&#39;</span><span style="color: #800000;">mysql.h</span><span style="color: #800000;">&#39;</span>  /usr/include/mysql/mysql.h</pre><p>&nbsp;</p><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><pre>[root@liu mysql]# find / -name <span style="color: #800000;">&#39;</span><span style="color: #800000;">*mysqlclient*</span><span style="color: #800000;">&#39;</span> /usr/lib64/mysql/libmysqlclient_r.so.<span style="color: #800080;">16.0</span>.<span style="color: #800080;">0</span>/usr/lib64/mysql/libmysqlclient.so.<span style="color: #800080;">16</span>/usr/lib64/mysql/libmysqlclient_r.so.<span style="color: #800080;">16</span>/usr/lib64/mysql/<span style="color: #000000;">libmysqlclient_r.so</span>/usr/lib64/mysql/<span style="color: #000000;">libmysqlclient.so</span>/usr/lib64/mysql/libmysqlclient.so.<span style="color: #800080;">16.0</span>.<span style="color: #800080;">0</span></pre><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><p>运行:</p><pre>[root@liu mysql]# ./mysql </pre><p>运行结果:</p><pre><span style="color: #000000;">共3个记录，每个记录2字段
id &nbsp; &nbsp; &nbsp;name</span><span style="color: #800080;">1</span><span style="color: #000000;"> &nbsp; &nbsp; &nbsp; 张三</span><span style="color: #800080;">2</span><span style="color: #000000;"> &nbsp; &nbsp; &nbsp; 李四</span><span style="color: #800080;">3</span>       王五</pre><p>一定要保持数据表编码,C文件编码的一致性,否则会出现乱码</p><p><br/></p>','首先确定系统上安装了GCC和MYSQL了没有,如果没有先安装.CentOS用yum -y install gccyum -y install mysql-server此外还必须安装mysql-devel安装成功检测:[root@liu my','1408328339','1408328339','67','1','1','0','','0','0','1','0');
INSERT INTO `tp_article` VALUES ('14','Linux C程序操作Mysql 调用PHP采集淘宝商品','','','','','','','<p>还是继续这个项目。</p><p>在上一篇Linux下利用Shell使PHP并发采集淘宝产品中，采用shell将对PHP的调用推到后台执行，模拟多线程。</p><p>此方法有一致命缺点，只能人工预判每个程序执行时间。如果判断时间少于执行时间，则会生成大量进程，如果判断时间多于执行时间，则会浪费时间资源。</p><p>所以，在此我们采用C程序来控制并发数。</p><p>整体思路和用shell调用相似，只是把shell控制改成了C。</p><p>下面是C程序：</p><p><span class="cnblogs_code_copy"><a title="复制代码"><img src="http://common.cnblogs.com/images/copycode.gif" alt="复制代码"/></a></span></p><pre><span style="color: #008080;"> 1</span> #include &lt;stdio.h&gt;<span style="color: #008080;"> 2</span> #include &lt;stdlib.h&gt;  
...
INSERT INTO `tp_category` VALUES ('6','案例','anli','0','3','0','','','','','List_product.html','Show_product.html','','1','1');
...
# 转存表中的数据：tp_product 
INSERT INTO `tp_product` VALUES ('1','321','','','','','<p>3213<br/></p>','3213','0','0','','','','1408328671','1408328671','94','6','1','0','','0','0','1','0');
