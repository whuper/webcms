...
-- Records of tp_admin
-- ----------------------------
INSERT INTO `tp_admin` VALUES ('1', 'admin', '0731a9e4628ba4dafe3c9b4e576ad7e2', 'umqvjg', '', '', '9', '1497326851', '127.0.0.1', '0');
...
CREATE TABLE `tp_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `pid` (`pid`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='栏目分类表';

-- ----------------------------
-- Records of tp_category
-- ----------------------------
INSERT INTO `tp_category` VALUES ('1', '关于我们', 'guanyuwomen', '0', '1', '0', '', '', '', '', 'List_page_about.html', 'Show_article.html', null, '1', '1', '');
INSERT INTO `tp_category` VALUES ('2', '新闻资讯', 'xinwenzixun', '0', '1', '0', '', '', '', '', 'List_news.html', 'Show_article.html', null, '1', '1', '');
INSERT INTO `tp_category` VALUES ('3', '联系我们', 'lianxiwomen', '0', '2', '0', '', '', '', '', 'List_page_contact.html', 'Show_article.html', null, '1', '1', '');
INSERT INTO `tp_category` VALUES ('4', '产品展示', 'chanpinzhanshi', '0', '3', '0', '', '', '', '', 'List_product.html', 'Show_article.html', null, '1', '1', '');
