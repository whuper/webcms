...
<div class="main">
	...
	<div class="form">
		...
		<dl>
			<dt> 商务通：</dt>
			<dd>
				<input type="text" name="cfg_swturl" class="inp_one inp_w250" value="<?php echo (C("cfg_swturl")); ?>" />
			</dd>
			<dd class="desc"></dd>
			<dd>cfg_swturl</dd>
		</dl>
	...
	<!--
		...
		<dl>
			<dt>邮箱密码：</dt>
			<dd>
				<input type="text" name="cfg_email_password" class="inp_one inp_w250" value="<?php echo (C("cfg_email_password")); ?>" />
			</dd>
			<dd class="desc"></dd>
