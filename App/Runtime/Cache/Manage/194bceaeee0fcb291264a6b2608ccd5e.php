...
<body>
<div class="main">
    <div class="pos">修改轮播图</div>
	<div class="form">
		<form method='post' id="form_do" name="form_do" action="<?php echo U(GROUP_NAME. '/PicPlay/edit');?>">
		<dl>
			<dt> 名称：</dt>
			<dd>
		...
		<dl>
			...
			<dd>
				<div class="litpic_show">
				    ...
				    <input type="text" class="inp_w250" name="pic" id="litpic"  value="<?php echo ($vo["pic"]); ?>" />
				    ...
				    <div id="litpic_show">
				    	<?php if($vo['pic']): ?><img src="<?php echo ($vo["pic"]); ?>" width='88' height='31' /><?php endif; ?>
				    </div>
				</div>
			</dd>
		</dl>	
