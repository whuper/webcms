...
$(function(){
	...
	$("input[name='username']").blur(function(){
		...
		$.post(CONTROL + URLPATHDEPR + "checkusername",{username:$.trim(username.val())},function(stat){
			if(stat==1){
				validate.username=0;
	...
	$("input[name='password']").blur(function(){
		...
		$.post(CONTROL+URLPATHDEPR+"checkpassword",{password:password.val(),username:$.trim(username.val())},function(stat){
			if(stat==1){
				validate.password=0;
